...
CREATE TABLE RTS_RSLT_MAS (
    ...
    PPK_OPER_REASON_CD   VARCHAR2(32),      -- 해당 (PLAN_PROD_ATTR_VAL,OPER_ID) 버킷 선택 사유 코드
    PPK_OPER_REASON_CTN  VARCHAR2(512),     -- 위 사유 상세(리워드 항목/계획·WIP 현황 근거)
    CARRIER_REASON_CD    VARCHAR2(32),      -- 버킷 내 CARRIER_ID 선택 사유 코드
    CARRIER_REASON_CTN   VARCHAR2(512),     -- 위 사유 상세
