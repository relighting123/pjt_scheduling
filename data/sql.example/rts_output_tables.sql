...
CREATE TABLE RTS_RSLT_INF (
    ...
    CRT_TM          VARCHAR2(19)   DEFAULT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') NOT NULL,
...
CREATE TABLE RTS_RSLT_HIS (
    ...
    CONSTRAINT PK_RTS_RSLT_HIS PRIMARY KEY (FAC_ID, EVENT_TIMEKEY, RULE_TIMEKEY, EQP_ID, SEQ_NO)
);
...
CREATE TABLE RTS_EQPCONVPLAN_INF (
    ...
    CRT_TM                  VARCHAR2(19)   DEFAULT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') NOT NULL,
    CHG_TM                  VARCHAR2(19)   DEFAULT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') NOT NULL,
