"""split 규칙 PPK×OPER×EQP_MODEL 키 테스트"""
...
def test_resolve_split_qty_by_oper():
    lookup = _build_split_lookup([
        {"PLAN_PROD_KEY": "PPK001", "OPER_ID": "OPER001", "EQP_MODEL": "A", "SPLIT_QTY": 3},
        {"PLAN_PROD_KEY": "PPK001", "OPER_ID": "OPER002", "EQP_MODEL": "A", "SPLIT_QTY": 5},
    ])
